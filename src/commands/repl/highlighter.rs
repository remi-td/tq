...
const SQL_KEYWORDS: &[&str] = &[
    ...
    "NORMALIZE", "PERIOD", "OVERLAPS", "CONTAINS",
];
...
const SQL_FUNCTIONS: &[&str] = &[
    ...
    "CSUM", "MSUM", "MAVG", // Teradata-specific aggregates
    // String functions
    "CONCAT", "SUBSTR", "SUBSTRING", "TRIM", "LTRIM", "RTRIM",
    "UPPER", "LOWER", "LENGTH", "CHAR_LENGTH", "POSITION",
    "REPLACE", "TRANSLATE", "COALESCE", "NULLIF",
    "LPAD", "RPAD", "REVERSE", "INITCAP",
    // Numeric functions
    "ABS", "CEIL", "CEILING", "FLOOR", "ROUND", "TRUNC", "TRUNCATE",
    "MOD", "POWER", "SQRT", "EXP", "LOG", "LN",
    "SIGN", "RANDOM", "GREATEST", "LEAST",
    // Date/time functions
    "CURRENT_DATE", "CURRENT_TIME", "CURRENT_TIMESTAMP",
    "DATE", "TIME", "TIMESTAMP", "INTERVAL",
    "EXTRACT", "DATE_TRUNC", "ADD_MONTHS", "MONTHS_BETWEEN",
    "YEAR", "MONTH", "DAY", "HOUR", "MINUTE", "SECOND",
    // Type conversion
    "CAST", "CONVERT", "TO_CHAR", "TO_DATE", "TO_NUMBER",
    "TRYCAST",
    // Conditional
    "IIF", "NULLIFZERO", "ZEROIFNULL", "NVL", "NVL2", "DECODE",
];
    ...
    fn is_number(&self, s: &str) -> bool {
        ...
        for (i, c) in s.chars().enumerate() {
            match c {
                ...
                '+' | '-' if has_exp && (s.chars().nth(i - 1) == Some('e')
                    || s.chars().nth(i - 1) == Some('E')) => continue,
                _ => return false,
            }
        }

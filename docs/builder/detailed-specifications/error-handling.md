...
1. [Error Categories](#91-error-categories)
2. [Error Message Structure](#92-error-message-structure)
3. [Progress Indicators](#93-progress-indicators)
4. [Warnings](#94-warnings)
5. [Verbose Output](#95-verbose-output)
6. [Logging](#96-logging-future)
